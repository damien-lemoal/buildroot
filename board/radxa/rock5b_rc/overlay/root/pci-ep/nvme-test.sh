...
if [ $# == 1 ]; then
	...
	dev="/dev/disk/by-id/$(ls /dev/disk/by-id/ | grep nvme-Linux_pci_epf | tail -1)"
fi
...
run_fio "Randwrite-128k-1x32" "randwrite" 131072 32 1 10

echo "  Randwrite, 128KB, QD=32, 4 jobs"
run_fio "Randwrite-128k-4x32" "randwrite" 131072 32 4 10

echo "  Randwrite, 512KB, QD=32, 1 job"
run_fio "Randwrite-512k-1x32" "randwrite" 524288 32 1 10

echo "  Randwrite, 512KB, QD=32, 4 jobs"
run_fio "Randwrite-512k-4x32" "randwrite" 524288 32 4 10
